...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  if (uLineStyle > 0.5) {
    ...
    if (uLineStyle < 1.5) {
      ...
      float dotMaskY2 = 1.0 - smoothstep(dotWidth2, dotWidth2 + fwidth(gridUV2 * dotRepeat2), cy2);
      float dotMaskX2 = 1.0 - smoothstep(dotWidth2, dotWidth2 + fwidth(gridUV2 * dotRepeat2), cx2);
      lineX2 *= dotMaskY2;
      lineY2 *= dotMaskX2;
    }
  }
